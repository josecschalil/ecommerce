...
const WishlistPage = () => {
  ...
  const EmptyWishlist = () => (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 px-4 py-20 md:py-30">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 px-4 py-20 md:py-24">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Recently Viewed */}
        <div className="mt-8 md:mt-12 backdrop-blur-md bg-white/20 rounded-2xl border border-white/30 shadow-xl p-4 md:p-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
            {[
              ...
              <div
                key={index}
                className="backdrop-blur-sm bg-white/30 rounded-xl border border-white/20 p-3 md:p-4 hover:bg-white/40 transition-all duration-300 group cursor-pointer flex flex-col"
              >
                <div className="relative mb-2 md:mb-3">
                  <img
                    src={product.image}
                    alt={product.name}
                    className="w-full h-28 md:h-40 object-cover rounded-lg group-hover:scale-105 transition-transform duration-300"
                  />
                  <button className="absolute top-1 md:top-2 right-1 md:right-2 p-1.5 rounded-full bg-white/80 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-all duration-200 hover:bg-white">
                    <Heart className="h-4 w-4 text-slate-600 hover:text-rose-500" />
                  </button>
                </div>
                <h4 className="font-medium text-slate-800 mb-1 md:mb-2 line-clamp-2 text-sm flex-grow">
                  {product.name}
                </h4>
                {/* --- MODIFICATION: Added price/button row --- */}
